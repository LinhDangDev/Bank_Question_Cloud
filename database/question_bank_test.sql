...
-- Kiểm tra xem database [question_bank_test] đã tồn tại chưa
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'question_bank_test')
BEGIN
    -- Đặt database về single user mode để có thể drop
    ALTER DATABASE question_bank_test SET SINGLE_USER WITH ROLLBACK IMMEDIATE
    -- Nếu database tồn tại, thực hiện drop database
    DROP DATABASE question_bank_test
    PRINT N'Database [question_bank_test] đã được drop thành công.'
END
GO

-- Tạo database [question_bank_test]
CREATE DATABASE question_bank_test
GO

PRINT N'Database [question_bank_test] đã được tạo thành công.'
GO
...
CREATE TABLE [dbo].[MonHoc](
 ...
 CONSTRAINT [PK_MonHoc] PRIMARY KEY CLUSTERED ([MaMonHoc] ASC)
) ON [PRIMARY]
GO

/****** Object:  Table [dbo].[CLO] - BẢNG ĐỘC LẬP ******/
CREATE TABLE [dbo].[CLO](
    [MaCLO] [uniqueidentifier] NOT NULL,
    [MaSoCLO] [nvarchar](20) NOT NULL, -- VD: CLO1, CLO2, CLO3
    [TenCLO] [nvarchar](500) NOT NULL,
    [MoTa] [nvarchar](max) NULL,
    [ThuTu] [int] NOT NULL,
    [TrangThai] [bit] NOT NULL DEFAULT(1), -- 1: Kích hoạt, 0: Vô hiệu hóa
    [NgayTao] [datetime] NOT NULL DEFAULT(GETDATE()),
    [NgaySua] [datetime] NULL,
    CONSTRAINT [PK_CLO] PRIMARY KEY CLUSTERED ([MaCLO] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO

/****** Object:  Table [dbo].[Phan] ******/
CREATE TABLE [dbo].[Phan](
 ...
 CONSTRAINT [PK_Phan] PRIMARY KEY CLUSTERED ([MaPhan] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO

/****** Object:  Table [dbo].[CauHoi] ******/
CREATE TABLE [dbo].[CauHoi](
	...
	[NgaySua] [datetime] NULL,
	[MaCLO] [uniqueidentifier] NULL, -- Liên kết với CLO (CLO là bảng độc lập)
 CONSTRAINT [PK_CauHoi] PRIMARY KEY CLUSTERED ([MaCauHoi] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO

/****** Object:  Table [dbo].[CauTraLoi] ******/
CREATE TABLE [dbo].[CauTraLoi](
	...
	[HoanVi] [bit] NOT NULL,
 CONSTRAINT [PK_CauTraLoi] PRIMARY KEY CLUSTERED ([MaCauTraLoi] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO

/****** Object:  Table [dbo].[DeThi] ******/
CREATE TABLE [dbo].[DeThi](
	...
	[DaDuyet] [bit] NULL,
 CONSTRAINT [PK_DeThi] PRIMARY KEY CLUSTERED ([MaDeThi] ASC)
) ON [PRIMARY]
GO

/****** Object:  Table [dbo].[ChiTietDeThi] ******/
CREATE TABLE [dbo].[ChiTietDeThi](
	[MaDeThi] [uniqueidentifier] NOT NULL,
	[MaPhan] [uniqueidentifier] NOT NULL,
	[MaCauHoi] [uniqueidentifier] NOT NULL,
	[ThuTu] [int] NOT NULL,
 CONSTRAINT [PK_ChiTietDeThi] PRIMARY KEY CLUSTERED ([MaDeThi] ASC, [MaPhan] ASC, [MaCauHoi] ASC)
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[Files](
 ...
 CONSTRAINT [PK_File] PRIMARY KEY CLUSTERED ([MaFile] ASC)
) ON [PRIMARY]
GO
...
/****** Object:  Table [dbo].[YeuCauRutTrich] ******/
CREATE TABLE [dbo].[YeuCauRutTrich](
 ...
 CONSTRAINT [PK_YeuCauDe] PRIMARY KEY CLUSTERED ([MaYeuCauDe] ASC)
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO

-- =============================================
-- Thêm các DEFAULT constraints
-- =============================================
...
-- MonHoc -> Khoa
ALTER TABLE [dbo].[MonHoc] WITH CHECK ADD CONSTRAINT [FK_MonHoc_Khoa] 
FOREIGN KEY([MaKhoa]) REFERENCES [dbo].[Khoa] ([MaKhoa]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[MonHoc] CHECK CONSTRAINT [FK_MonHoc_Khoa]
GO

-- Phan -> MonHoc
ALTER TABLE [dbo].[Phan] WITH CHECK ADD CONSTRAINT [FK_Phan_MonHoc] 
FOREIGN KEY([MaMonHoc]) REFERENCES [dbo].[MonHoc] ([MaMonHoc]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[Phan] CHECK CONSTRAINT [FK_Phan_MonHoc]
GO

-- CauHoi -> Phan
ALTER TABLE [dbo].[CauHoi] WITH CHECK ADD CONSTRAINT [FK_CauHoi_Phan] 
FOREIGN KEY([MaPhan]) REFERENCES [dbo].[Phan] ([MaPhan]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[CauHoi] CHECK CONSTRAINT [FK_CauHoi_Phan]
GO

-- CauHoi -> CLO (CLO bây giờ là bảng độc lập)
ALTER TABLE [dbo].[CauHoi] WITH CHECK ADD CONSTRAINT [FK_CauHoi_CLO] 
FOREIGN KEY([MaCLO]) REFERENCES [dbo].[CLO] ([MaCLO]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [dbo].[CauHoi] CHECK CONSTRAINT [FK_CauHoi_CLO]
GO

-- CauTraLoi -> CauHoi
ALTER TABLE [dbo].[CauTraLoi] WITH CHECK ADD CONSTRAINT [FK_CauTraLoi_CauHoi] 
FOREIGN KEY([MaCauHoi]) REFERENCES [dbo].[CauHoi] ([MaCauHoi]) ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[CauTraLoi] CHECK CONSTRAINT [FK_CauTraLoi_CauHoi]
GO

-- DeThi -> MonHoc
ALTER TABLE [dbo].[DeThi] WITH CHECK ADD CONSTRAINT [FK_DeThi_MonHoc] 
FOREIGN KEY([MaMonHoc]) REFERENCES [dbo].[MonHoc] ([MaMonHoc]) ON UPDATE CASCADE
GO
...
-- ChiTietDeThi -> DeThi
ALTER TABLE [dbo].[ChiTietDeThi] WITH CHECK ADD CONSTRAINT [FK_ChiTietDeThi_DeThi] 
...
-- ChiTietDeThi -> Phan
ALTER TABLE [dbo].[ChiTietDeThi] WITH CHECK ADD CONSTRAINT [FK_ChiTietDeThi_Phan] 
...
-- ChiTietDeThi -> CauHoi
ALTER TABLE [dbo].[ChiTietDeThi] WITH CHECK ADD CONSTRAINT [FK_ChiTietDeThi_CauHoi1] 
FOREIGN KEY([MaCauHoi]) REFERENCES [dbo].[CauHoi] ([MaCauHoi])
GO
ALTER TABLE [dbo].[ChiTietDeThi] CHECK CONSTRAINT [FK_ChiTietDeThi_CauHoi1]
GO

-- Files -> CauHoi
ALTER TABLE [dbo].[Files] WITH CHECK ADD CONSTRAINT [FK_File_CauHoi] 
FOREIGN KEY([MaCauHoi]) REFERENCES [dbo].[CauHoi] ([MaCauHoi])
GO
...
-- =============================================
CREATE NONCLUSTERED INDEX [IX_CauHoi_CLO] ON [dbo].[CauHoi]([MaCLO]) INCLUDE ([MaCauHoi], [NoiDung])
GO

CREATE NONCLUSTERED INDEX [IX_CLO_MaSoCLO] ON [dbo].[CLO]([MaSoCLO]) INCLUDE ([TenCLO], [MoTa])
GO

CREATE NONCLUSTERED INDEX [IX_CauHoi_Phan] ON [dbo].[CauHoi]([MaPhan]) INCLUDE ([MaCauHoi], [MaCLO])
GO

PRINT N'Database và tất cả các bảng đã được tạo thành công!'
